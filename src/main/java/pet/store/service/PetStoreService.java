...
public class PetStoreService {
	...
	private Employee findEmployeeById(Long petStoreId, Long employeeId) {
		...
		if (employee.getPetStore().getPetStoreId() != petStoreId) {
			throw new IllegalArgumentException("Employee with ID=" + employeeId + " is not employed by pet store with ID=" + petStoreId + " .");
	...
	private Customer findCustomerById(Long petStoreId, Long customerId) {
		...
		if (petStore.getPetStoreId().equals(petStoreId)) {
			...
			throw new IllegalArgumentException("Customer with ID=" + customerId + " is not a customer at pet store with ID=" + petStoreId + " .");
